...
export async function GET(
  ...
  try {
    ...
    const response = await axios.get(
      `${config.panelUrl}/api/client/servers/${server.pterodactylIdentifier}/startup`,
      {
        headers: {
...
export async function PUT(
  ...
  try {
    ...
    const response = await axios.put(
      `${config.panelUrl}/api/client/servers/${server.pterodactylIdentifier}/startup/variable`,
      body,
      {
        headers: {
          'Authorization': `Bearer ${adminApiKey}`,
